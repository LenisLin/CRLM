...
sc.pl.draw_graph(malignant_cells, color="Malignant_type", legend_loc="on data",show=False)
plt.tight_layout()
plt.savefig(os.path.join(save_path, "draw_graph_malignant_type.pdf"), dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(save_path, "paga_malignant_type.pdf"), dpi=300, bbox_inches='tight')
plt.show()

sc.tl.draw_graph(malignant_cells, init_pos="paga")
sc.pl.draw_graph(malignant_cells, color="Malignant_type", legend_loc="on data")
plt.tight_layout()
plt.savefig(os.path.join(save_path, "draw_graph_paga_init.pdf"), dpi=300, bbox_inches='tight')
plt.show()
...
sc.pl.draw_graph(malignant_cells, color=["Malignant_type", "dpt_pseudotime"], 
                 legend_loc="on data", show=False)
plt.tight_layout()
plt.savefig(os.path.join(save_path, "draw_graph_pseudotime.pdf"), dpi=300, bbox_inches='tight')
plt.show()